...
if __name__ == '__main__':
    # model = yolo_workouts()
    # model.set_model_video(model_name="ncnn-n", video_path=video_path)
    # model.set_motion_type(motion_type=motion_type, show=show, verbose=verbose)
    # model.detect_video()
    ...
    # run_model_motion_video("ncnn-n", "引体向上", "./video/引体向上-反.mp4", show=True, verbose=True)

    run_model_motion_video("ncnn-n", "深蹲-左", "./video/深蹲-左.mp4", show=True, verbose=True)
